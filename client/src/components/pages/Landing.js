                ...
                <div className="row">
                    <div className="col s12 m4 l4">
                        <div className="icon-block">
                            <h2 className="center light-black-text"><i className="material-icons medium">flash_on</i></h2>
                    ...
                    <div className="col s12 m4">
                        <div className="icon-block">
                            <h2 className="center light-black-text"><i className="material-icons medium">group</i></h2>
                    ...
                    <div className="col s12 m4">
                        <div className="icon-block">
                            <h2 className="center light-black-text"><i className="material-icons medium">settings</i></h2>
